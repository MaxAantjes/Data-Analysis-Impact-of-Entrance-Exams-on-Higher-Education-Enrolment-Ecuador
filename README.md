...
17/06/2020
  ...
  - [valor de análysis](#valor-de-análysis)
...
**Este proyecto explora, mide y modela los factores socioeconomico y
geográfico que han influido el acceso a educación superior de jóvenes en
Ecuador en el periodo 2009 a 2017.**

# valor de análysis

Aunque hay cifras sobre la composición de jovenes matriculados en
escuelas, universidades y politécnicas en nivel nacional y provincial
(vea por ejemplo [las cifras
de 2018](https://www.educacionsuperior.gob.ec/cifras-a-nivel-nacional-y-provincial-de-la-oferta-academica-acceso-y-permanencia-en-el-sistema-de-educacion-superior/)),
falta una análisis en nivel de cantón. Una análisis así tendría valor
porque podría examinar las diferencias en oportunidades entre jóvenes
que son de diferentes parte de una provincia. Por ejemplo, las
diferencias en los estados economícos de cantónes y sus recursos
ecónomicos crearían una barrera por algunos. de sus En consecuencia,
este proyecto traté de utilizar la existencia de los códigos postales en
Ecuador y el aumento de su gobierno en la recolleción de las encuestas
de empleo, desempleo y subempleo (ENEMDU), para crear una análisis
así.\*\*
